...
The main application for creating a visualization platform for observing arm movement.
...
import optparse, pyglobals, sys, os.path

#
# Parse command line arguments
#

op = optparse.OptionParser(prog=pyglobals.program_name,
			   add_help_option=True,
			   description=pyglobals.program_description,
			   version=pyglobals.vers_desc,
			   usage="%prog [-d:] file",
...
pyglobals.set_data_file(args[0])

# check for validity of data file
if not os.path.isfile(pyglobals.data_file):
	print "* [ERROR] Invalid data file (" + pyglobals.data_file + ")!"
	sys.exit(pyglobals.DATA_ERROR)
#
...
if f_list.verbose:
	print ""
	print "%s v%s" % (pyglobals.program_name, pyglobals.version)
	print "Written by %s" % pyglobals.author
	print pyglobals.date
	print "-------------------------------------------------"

# print out extra information

if f_list.verbose:
	print "Current Data Path: " + pyglobals.data_file
